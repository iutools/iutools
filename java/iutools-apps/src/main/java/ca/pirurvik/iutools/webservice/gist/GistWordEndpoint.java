...
import ca.pirurvik.iutools.webservice.OccurenceExampleInputs;
import ca.pirurvik.iutools.webservice.OccurenceExampleResponse;
...
public class GistWordEndpoint extends HttpServlet {
	...
	private void writeJsonResponse(HttpServletResponse response, String json) throws IOException {
		Logger tLogger = Logger.getLogger("ca.pirurvik.iutools.webservice.OccurenceExampleEndpoint.writeJsonResponse");
