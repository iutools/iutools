...
public abstract class Trie_BaseTest {
	
	protected abstract Trie_Base makeTrie();
	...
	@Test
	public void test__Trie_Base__Synopsis() {
		//
		// Use a Trie_Base to index a sequence of 'segments' of a string.
		//
		...
		// parts. You would then create a Trie_Baseas follows:
		//
		Trie_Base trie = makeTrie();
	...
	public void test_add__check_terminal_inuktitut() throws Exception {
		...
		Trie_Base iumorphemeTrie = makeTrie();
		try {
	...
	public void test_toJSON__Char() throws TrieException {
		...
		Gson gson = new Gson();
		Trie_Base retrievedCharTrie = gson.fromJson(json,Trie_Base.class);
