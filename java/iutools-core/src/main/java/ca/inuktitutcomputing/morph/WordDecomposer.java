...
public class WordDecomposer {
    ...
    public long millisTimeout = 10000;
    ...
    public Decomposition[] decomposeWord(String word) throws Exception {
...
//            decs = decsC;
    ...
    private Vector decompose(String term, boolean isSyllabic, boolean decomposeBase) throws Exception
    {
...
//        }
    ...
    private Vector<Decomposition> decompose_simplified_term(String term, String termOrig,
	...
	private Vector<SurfaceFormOfAffix> eliminateByArcsFollowedEtc(Vector<?> onesFound, Graph.State [] states,
...
//    	System.out.println(onesFound.size()+" > "+onesFoundDiminue.size());
     ...
     */
    private Vector<Decomposition> decomposeByAffixes(Vector<?> onesFound,
...
//                        checkPossibleDialectalChanges
     ...
     */
    private Vector<Decomposition> analyzeAsRoot(String termICI, String termOrigICI, 
...
//                condsSpecs,preCond,transitivity);
    ...
    private Vector checkRoots(Vector lexs, String word, String termOrigICI,
     ...
     */
    private boolean sameAsNext(Morpheme morpheme, Vector partsAlreadyAnalyzed) {
        boolean res = true;
    ...
    private Hashtable arcsByMorpheme = new Hashtable();
     ...
     */
    private Object[][] agreeWithContextAndActions(String affixCandidateOrig,
     ...
     */
    private Vector checkForDoubleConsonantInVerbalRoots(Vector rootCandidates) {
