...
//
// Description: Diverses m�thodes associ�es aux caract�res inuktitut
//
// -----------------------------------------------------------------------
...
//    public static int VV = 3; // voyelle double
    ...
    /*
     * transcoder et getTranscoder() ne sont plus n�cessaires depuis qu'on a
     * recod� les fonctions de transcodage.
     */
