...
import org.iutools.search.IUSearchEngine;
...
public class SearchEndpoint extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Logger tLogger = Logger.getLogger("org.iutools.webservice.SearchEndpoint.doPost");
	...
	public SearchResponse executeEndPoint(SearchInputs inputs) throws SearchEndpointException  {
		Logger tLogger = Logger.getLogger("org.iutools.webservice.SearchEndpoint.executeEndPoint");
	...
	private SearchResults search(List<String> queryWords, SearchInputs inputs) throws SearchEndpointException {
		Logger tLogger = Logger.getLogger("org.iutools.webservice.SearchEndpoint.search");
		if (tLogger.isTraceEnabled()) {
	...
	protected void expandQuery(String query, SearchResponse results)
		...
		Logger tLogger = Logger.getLogger("org.iutools.webservice.SearchEndpoint.expandQuery");
