...
//		ESRepairDaemon.start(false);
	...
	private void writeJsonResponse(HttpServletResponse response, String json) throws IOException {
		Logger tLogger = Logger.getLogger("org.iutools.webservice.OccurenceSearchEndpoint.writeJsonResponse");
	...
	public OccurenceSearchResponse executeEndPoint(OccurenceSearchInputs inputs) throws Exception {
		Logger logger = Logger.getLogger("org.iutools.webservice.OccurenceSearchEndpoint.executeEndPoint");
