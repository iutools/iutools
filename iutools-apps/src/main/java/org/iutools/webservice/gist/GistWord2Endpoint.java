...
public class GistWord2Endpoint
	extends Endpoint<GistWord2Inputs, GistWord2Result> {
	@Override
	protected GistWord2Inputs requestInputs(HttpServletRequest request) throws ServiceException {
		return jsonInputs(request, GistWord2Inputs.class);
	}

	@Override
	public EndpointResult execute(GistWord2Inputs inputs) throws ServiceException {
		Logger tLogger = Logger.getLogger("org.iutools.webservice.GistWordEndpoint.execute");

		GistWord2Result response = new GistWord2Result(inputs.word);
