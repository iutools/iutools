...
public class GistWordInputsTest extends ServiceInputsTest {
	...
	public void test__summarizeForLogging() throws Exception {
		...
		new AssertServiceInputs(inputs)
			.logSummaryIs("{\"_action\":null,\"_taskID\":null,\"_taskStartTime\":null,\"taskElapsedMsecs\":null,\"word\":\"inuksuk\",\"wordRomanized\":\"inuksuk\"}");
			;

		inputs =
			new GistWordInputs("ᐃᓄᒃᓱᒃ");
		new AssertServiceInputs(inputs)
			.logSummaryIs("{\"_action\":null,\"_taskID\":null,\"_taskStartTime\":null,\"taskElapsedMsecs\":null,\"word\":\"ᐃᓄᒃᓱᒃ\",\"wordRomanized\":\"inuksuk\"}");
			;
	}
}