...
public abstract class TrieTest {
	...
	public void test__Trie__Synopsis() throws Exception {
		...
		//
		node = trie.node4keys("nonexistant".split(""), Trie.NodeOption.NO_CREATE);
		...
		//
		node = trie.node4keys("hello".split(""), Trie.NodeOption.TERMINAL);
		
		// You can also use NO_CREATE and TERMINAL together
		//
		node = trie.node4keys("nonexistant".split(""),
					Trie.NodeOption.NO_CREATE, Trie.NodeOption.TERMINAL);
	...
	public void test__node4keys__NO_CREATE() throws Exception {
		...
		TrieNode node = charTrie.node4keys(nonExistantKeys, Trie.NodeOption.NO_CREATE);
		Assert.assertTrue(
	...
	public void test__node4keys__TERMINAL() throws Exception {
		...
		TrieNode node = charTrie.node4keys(helloChars, Trie.NodeOption.TERMINAL);
		Assert.assertTrue(
	...
	public void test__add__FreqIncrementGreaterThanOne() throws Exception {
		...
		TrieNode terminalNode = charTrie.node4keys(wordChars, Trie.NodeOption.TERMINAL);
		...
		terminalNode = charTrie.node4keys(wordChars, Trie.NodeOption.TERMINAL);
		new AssertTrieNode(terminalNode, 
	...
	public void test__add__NullInputSegments() throws Exception {
		...
		TrieNode gotNode = charTrie.node4keys(nullSegments, Trie.NodeOption.TERMINAL);
...
//			expSurfFormFreqs, terminalNode.getSurfaceForms());
	...
	public void test__add_get__Char() throws Exception {
		...
		TrieNode node = charTrie.node4keys(helloChars, Trie.NodeOption.NO_CREATE);
