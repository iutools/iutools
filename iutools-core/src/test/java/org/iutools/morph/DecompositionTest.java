...
public class DecompositionTest {
	...
	public void test__Decomposition__Synopsis() throws Exception {
		...
		// At this point, there is not easy way to create a DecompositionSimple
		...
		DecompositionSimple simple = decomp.toSimpleDecomposition();
	...
	public void test__toSimpleDecomposition() throws Exception {
		DecompositionSimple gotSimple = decomp.toSimpleDecomposition();
		AssertObject.assertDeepEquals(
			"Simple decomp not as expected",
			new DecompositionSimple("makpi:makpiq/1v gaq:gaq/1vn"), gotSimple
		);
	}
