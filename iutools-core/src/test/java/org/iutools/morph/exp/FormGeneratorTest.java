	...
	public void test_run__Case_root() throws FormGeneratorException, IOException, LinguisticDataException {
		...
		List<SurfaceFormInContext> expectedForms = 
				new ArrayList<SurfaceFormInContext>(
						Arrays.asList(
						new SurfaceFormInContext("malik","",null,morpheme),
						new SurfaceFormInContext("mali","",null,morpheme),
						new SurfaceFormInContext("malip","",null,morpheme),
						new SurfaceFormInContext("malit","",null,morpheme),
						new SurfaceFormInContext("malig","",null,morpheme),
						new SurfaceFormInContext("maling","",null,morpheme),
						new SurfaceFormInContext("malij","",null,morpheme),
						new SurfaceFormInContext("malil","",null,morpheme),
						new SurfaceFormInContext("maliv","",null,morpheme)));
