...
//		focusOnCase = 3;
	...
	public void test__splitText_SeveralCases() throws Exception {
		...
		Object[][] splitCases = new Object[][] {
			...
			// Lemmatized tokens... Two @ or more should be treated as a wildcard
			// Those are generated by Portage.
			new Object[] {
				"Greetings, old universe",
				new String[] {
					// Usually, Portage uses @@ for wildcard
					"greet@@",
					"old",
					// But sometimes, Portage uses @@@ instead of @@ (not sure why)
					"uni@@@", "@@rse"},
