...
public class Aligner_MalignaTest {
	...
	public void test__Aligner_Maligna__CallAsMain() throws Exception {
		String f1Path = ResourceGetter.getResourcePath("org/iutools/concordancer/l1_sents.txt");
		String f2Path = ResourceGetter.getResourcePath("org/iutools/concordancer/l2_sents.txt");
