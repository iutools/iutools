...
public class Orthography {
    ...
    //-------------------------------------------------------------------------------
    // Pour faciliter l'analyse des termes, on convertit certains caract�res
    //-------------------------------------------------------------------------------
    
    
    //--------------------------------- simplifi� -----------------------------------
    // Orthographe simplifi� pour simplifier les diverses t�ches d'analyse du texte
    // inuktitut
    ...
    // Pr�-traitement du mot � translitt�rer en syllabique.
    // (Utilis�e par translittererLatSyl)
    // Remplacement de:
    //   nng par X
    //   ng N
    //   qq par qk
...
//            OutputStreamWriter out = new OutputStreamWriter(System.out, "UTF-8");
            ...
            for (int i = 0; i < lengthTerm; i++) {
                ...
                // Caract�re avec voyelle point�e (double): indV >= 0
    ...
    // � partir d'un texte � orthographe simplifi�.
    ...
    /*
     * �ventuellement, il faudra ajouter les caract�res latins utilis�s au
     * Nunatsiavut; par exemple, �, &, l barr� (\u0142)
     */
    static String UnicodeWordChars = "[a-zA-Z\\u1400-\\u167f0-9\\-\\&�\\u0142]";
    ...
    public static boolean isUnicodeInuktitutWord(String word) {
    	...
    	boolean result = true;
    	for (char c : chars) {
            Matcher m = pwordChars.matcher(""+c);
    		if (!m.matches()) {
    			result = false;
    			break;
    		}
