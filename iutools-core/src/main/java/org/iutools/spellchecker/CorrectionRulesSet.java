	...
	public static CorrectionRule[] rules() throws SpellCheckerException {
		if (_allRules == null) {
			_allRules = new CorrectionRule[] {
				...
				// character will usually be transcoded as two.
				//
				...
				//
				new CorrectionRule("(ᖅ|ᕐ|ᑦ|ᑉ|ᔅ|ᒡ|ᔾ|ᒃ|ᓪ|ᕝ|ᓐ|ᒻ|ᖦ|ᖕ|ᖖ){2}", null, false),
				...
				new CorrectionRule("(ᕗ|ᕘ|ᕕ|ᕖ|ᐳ|ᐴ|ᒧ|ᒨ|ᓄ|ᓅ|ᑐ|ᑑ)$", null, true),

				// Cannot have three vowels in a row
				new CorrectionRule("(ᐃ|ᐅ|ᐊ){3}", null, true),
