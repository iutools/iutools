...
// Additions dans la table de codes, d� � l'installation d'une nouvelle version de Nunacom contenant plus de codes que l'ancienne.
//
...
public class FontEmiinuktitut {
    ...
    // i
            ...
            { "\u15A3", "~L" }, // &uu
            { "\u15A3", "\u00d2" }, // &uu
            // On rencontre dans la r�alit� les codes pour "quu", "nguu"
            // et "nnguu" cod�s par un code de point et la syllabe
            // courte.
            { "\u1582", "+d" }, // quu
            { "\u1592", "+a" }, // nguu
            ...
            { "\u15A5", "\u02c6" }, // &aa
            { "\u15A5", "\u0088" }, // &aa
            // On rencontre dans la r�alit� les codes pour "ngaa"
            // et "nngaa" cod�s par un code de point et la syllabe
            // courte.
            { "\u1594", "+z" }, // ngaa
            { "\u1676", "+U" },  // nngaa
    ...
    public static String unicodesICI2CodesOthers[][] = {
            ...
            { "\u2018", "\u0091" }, // guillemet-apostrophe culbut�
            { "\u2019", "\u0092" }, // guillemet-apostrophe
            { "\u201c", "\u0093" }, // guillemet-apostrophe double culbut�
    ...
    static public String transcodeToUnicode(String s, String aipaitaiMode) {
        ...
        while (i < l) {
           ...
           case '\u0063': // qa
            ...
            case '\u00c6': d = '\u201c'; break; //guillemet-apostrophe double culbut�
            case '\'': d = '\u2019'; break; //guillemet-apostrophe
            case '\u00e6': d = '\u2018'; break; //guillemet-apostrophe culbut�
            case '\u0060':
            case '\u0091':
                d=c; dot = true; break;
            default: if (dot) {
...
//          case '\u15A5': d = '\u02c6'; break; // &aa
          case '\u15A5': d = '\u00ee'; break; // &aa
           ...
           case '+': d = '\u0054'; break;
            case '=': d = '\u0055'; break; // 
            case '\u2018': d = '\u00e6'; break; // guillemet-apostrophe culbut�
            case '\u2019': d = '\''; break; // guillemet-apostrophe
            case '\u201c': d = '\u00c6'; break; // guillemet-apostrophe double culbut�
            case '\u201d': d = '\u0022'; break; // guillemet-apostrophe double
            case '\u2022': d = '\u00a7'; break; // puce
            case '\u2014': d = '\u0097'; break; // tiret cadratin
            default: d = c; break;
