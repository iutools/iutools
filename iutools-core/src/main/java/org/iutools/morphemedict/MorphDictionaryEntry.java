...
public class MorphDictionaryEntry {
	...
	public List<ScoredExample> words = new ArrayList<ScoredExample>();
	...
	public MorphDictionaryEntry(String _morphemeWithId, List<ScoredExample> _words) throws MorphemeException {
		this.init_MorphDictionaryEntry(_morphemeWithId, _words);
	}

	public void init_MorphDictionaryEntry(String _morphemeWithId, List<ScoredExample> _words) throws MorphemeException {
